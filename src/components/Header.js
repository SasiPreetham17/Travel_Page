...
const Header = () => {
  ...
  return (
    <div className="container">
      <div className="blended_color_1"></div>
      <div className="blended_color_2"></div>
      <div className="content">
        <div className="nav-content">
          ...
          <div className="auth-buttons">
            <Link to="/" className="login-button" onClick={handleClick}>
              Log In
            </Link>
            <Link to="/" className="signup-button" onClick={handleClick}>
              Sign Up
            </Link>
          </div>
        </div>
